			...
			// Functions
				...
				$f = "
					...
					CREATE FUNCTION FULLIMG(img TEXT)
					  ...
					  LANGUAGE SQL
					BEGIN
					  RETURN CONCAT('http://img.goldfishing.hu/',IF(img IS NULL,'products/noimg.png',img));
					END;
					$$
					DELIMITER ;";
				// B2B Termék ár számoló
				$f .= "DROP FUNCTION IF EXISTS getB2BTermekAr;
				DELIMITER $$
				CREATE FUNCTION getB2BTermekAr(marka INT, ar FLOAT)
				  RETURNS FLOAT
				BEGIN
